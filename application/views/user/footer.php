      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Back_User/semua_kos"><span class="fa fa-chevron-right mr-2"></span>Search Properties</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Back_User/services"><span class="fa fa-chevron-right mr-2"></span>Services</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Back_User/about_us"><span class="fa fa-chevron-right mr-2"></span>About Us</a></li>
            <li><a href="<?php echo base_url() ?>Main_Back_User/contact"><span class="fa fa-chevron-right mr-2"></span>Contact</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              ...
              <li><a href="tel:(0274) 4534571"><span class="icon fa fa-phone"></span><span class="text">(0274) 4534571</span></a></li>
              <li><a href="mailto:cs@sevenkos.com"><span class="icon fa fa-envelope pr-4"></span><span class="text">cs@sevenkos.com</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          ...
          </script> All rights reserved | This website is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="<?php echo base_url() ?>" target="_blank">SevenKos</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
