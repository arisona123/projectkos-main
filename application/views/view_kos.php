                ...
                <div class="col-md-6">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <button href="<?= base_url() ?>User/edit_kos/<?= $kos->id_kos ?>" class="btn btn-primary btn-block waves-effect" type="button" role="button">EDIT</button>
                                <button onclick="return confirm('Anda Yakin Akan Menghapus Data Ini ?')" href="<?= base_url() ?>User/delete_kos/<?= $kos->id_kos ?>" class="btn btn-danger btn-block waves-effect" type="button" role="button">DELETE</button>
                            </p>
                        </div>
                    </div>
                </div>
